...
function useWishList() {
  ...
  const debouncedSave = useRef(debounce((quantity) => saveChangeInput(quantity), 100)).current
  const debouncedRemove = useRef(debounce((quantity) => saveRemove(quantity), 100)).current
