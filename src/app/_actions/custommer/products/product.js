...
export const actLoadAllProductListRequest = (limit, page) => {
  return (dispatch) => {
    return apiLocalhost0(`Newee/ProductSeller/Getlist/${limit}/${page}`, 'GET', null)
      .then((res) => {
...
// Not Token = load all product

export const actLoadAllProductListRequestPublic = (limit, page) => {
  return (dispatch) => {
    return apiLocalhost0(`Newee/ProductPublic/Getlist/${limit}/${page}`, 'GET', null)
      .then((res) => {
        console.log('responsive public', res.data.data)
        dispatch(actLoadAllProductList(res.data.data))
      })
      .catch((err) => console.log(err.response))
  }
}

// Token = load all product

// PRODUCT PUBLIC  = Name

// Category
export const actLoadCategory = (categories) => {
  return {
    type: types.PRODUCT_GET_CATEGORY,
    categories,
  }
}

export const actProductLoading = () => {
  console.log('đã chạy act Loading')
  return {
    type: types.PRODUCT_LOADING,
  }
}

export const actLoadProduct = (products) => {
  return {
    type: types.PRODUCT_GET_ALL,
    products,
  }
}
export const actLoadProductError = (errors) => {
  return {
    type: types.PRODUCT_ERROR,
    errors,
  }
}
export const privateError = (errors) => {
  return {
    type: types.PRIVATE_ERROR,
    errors,
  }
}

// PRODUCT PRIVATE = Name + Pr

export const privatePushInfo = (info) => {
  return {
    type: types.USER_INFO,
    info,
  }
}
export const privateLoadCart = (cart) => {
  return {
    type: types.PRIVATE_CART_LOADING,
    cart,
  }
}

export const Push = (_type, payload) => {
  console.log(_type)
  return {
    type: _type,
    payload,
