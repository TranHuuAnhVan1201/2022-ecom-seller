...
function Login({ setToken }) {
  ...
  const handleLoginClick = async (data) => {
    try {
      const user = await dataLoginApiPr.login(data)
    ...
    <section>
      <div className="container-login">
        <div className="left mt-4">
          <div>
            {/*<p>Tài khoản Test: tranhuuanhvan121@gmail.com - Anhvan_234</p>
            <p>Tài khoản Test: ngoctu61344 - 123@Admin</p>*/}
          </div>
        </div>
        <div className="right">
          <div className="card-body mt-4">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <button type="submit" className="btns larger submit btns-login-register">
                Đăng nhập
              </button>
