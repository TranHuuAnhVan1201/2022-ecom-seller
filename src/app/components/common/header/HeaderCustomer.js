...
export const HeaderCustomer = memo(() => {
  ...
  function handleSearchTermChange(e) {
    ...
    if (e.key === 'Enter') {
      //history.replace(`/tim-kiem?keyword=${searchTerm}`)
  ...
  function handleClickMenu(name, id) {
    //history.replace(`/tim-kiem?keyword=${name}`)
                ...
                <div className="container">
                  ...
                  <div className="history menus">
                    <div className="header__navbar-item header__navbar-item-has-qr header__navbar-item--separate">
                      ...
                      <div className="header__qr">
                        <div className="header__qr-apps">
                          <Link to="/" className="header__qr-link" onClick={() => onLogin()}>
                            <p>
                              <span>Đăng nhập</span>
                            </p>
                          </Link>
                          <Link to="/" className="header__qr-link" onClick={() => onRegister()}>
                            <p>
                              <span>Đăng ký</span>
                            </p>
                          </Link>
                  ...
                  <div className="search-result">
                    {states.keyword.length === 0 ? (
                      ...
                      <div className="search-result-list">
                        {states.productLikeFilter.length > 0 ? (
                          states.productLikeFilter.map((value) => (
                            <Link to={`/san-pham/${ToSlug(value.name)}.${value.id}`} key={value.id}>
                              <div className="search-result-span">
                                <span>
                                  <BiSearchAlt />
                                </span>
