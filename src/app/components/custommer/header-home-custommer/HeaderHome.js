...
function HeaderHome(props) {
  ...
  useEffect(() => {
    if (dataLogin.dataLogin.code && parseInt(dataLogin.dataLogin.code.slice(2)) >= 2021000199) {
      setTotalKM(100000)
    }
  })
        ...
        <div className={active === true ? 'header search-active' : 'header'}>
          <div className="header-top-left">
            ...
            <div className="search-container" ref={node}>
              ...
              <div>
                <div className={visible ? 'container-show active' : 'container-show'}>
                          ...
                          state.productsFilter.map((item, key) => {
                            return (
                              <div className="styles-container">
                                <Link
                                  to={'/product-detail/' + ToSlug(item.name) + '.' + item.id}
                                  onClick={() => getIDPRODUCT(item.id)}
                                >
                                  <div className="show-body-item">
                                    <i className="fas fa-search"></i>
                                    <div className="styles-image">
                                      <img src={item.link} alt="newee-asia"></img>
                                    </div>
          ...
          <div className="header-top-right">
              ...
              <div className="col col-user">
                <div className="login-register">
                  <p className="span-user">
                    <span>
                      Tài khoản <br />
                      {dataLogin.dataLogin.code !== undefined
              ...
              <div className="col col-user">
                ...
                {check ? (
                  ...
                  <div className="user-dropdown menus position-absolute top-36 btn-header ">
                    ...
                    >
                      <p>
                        <span className="span-center span-border-none">Đăng nhập</span>
                      </p>
                    </Link>
                    <Link
                      to="/"
                    ...
                    >
                      <p>
                        <span className="span-center span-border-none">Đăng ký</span>
                      </p>
                    </Link>
                    ...
                    <Link
                      to="/"
                      className="Userdropdown-button btns-zalo"
                      onClick={() => onLogin()}
                    >
                      <p>
                        <img
            ...
            <div className="header-login header-cart">
              ...
              <div className="col col-user notification">
                <div className="user-dropdown acount position-absolute top-36">
                  {/* <Link to="/admin/analysis" className={totalKM !== 0 ? "" : "d-none"}>
                      <button type="button" className="btn btn-primary">
                        Khuyến mãi đăng ký mới<span className="badge badge-light" style={{ marginLeft: '6px' }}>1</span>
                      </button>
                    </Link> */}

                  <ul id="notification-menu" className="dropdown-menu-2 notification-menu">
                    ...
                    <div className="dropdown-menu-content overlay-scrollbar scrollbar-hover">
                      ...
                      <li className={totalKM !== 0 ? 'dropdown-menu-item' : 'd-none'}>
