...
function Search(props) {
  ...
  useEffect(() => {
    ...
    getCategoryPublic();
    getCategory();
    getProductPublicWidthCategory(
      "801d0f4d-8a54-4a7e-8837-804cf42f8729",
      1000,
      1
    );
  ...
  useEffect(() => {
    if (FetchProduct.length === 0) {
      dispatch(actions.actLoadAllProductListRequest(100, 1));
      setList(FetchProduct);
    }
  ...
  const getProductPublicWidthCategory = (
    ...
    apiLocalhost0(
      ...
      .then((res) => {
        console.log("da chay getProductPublicWidthCategory => ", res);
        // setListCategoryPublic(res.data);
      ...
      <div className="search-all">
        <div className="container">
          ...
          <div className="right">
            ...
            <div className="body">
              {checks ? (
                <SearchResult data={list !== [] || list ? list : null} />
              ) : null}
            </div>
          </div>
        </div>
