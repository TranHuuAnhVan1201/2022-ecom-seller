...
import FormBank from './FormShare/FormBank2'
import FormShare from './FormShare/FormShare2'
...
function Checkout2(props) {
  ...
  const {
    user,
    cart: { cartItems, cartLength, totalPayment, totalPaymentSeller },
    userInfo,
  ...
  const getPriceShippingGHTK = (province, town) => {
    ...
    apiLocalhost0(`ghtk/shipmentfee`, 'POST', data)
      ...
      .catch((err) => {
        alert('Tạo đơn hàng không thành công! Vui lòng đăng nhập lại! Xin cảm ơn!')
  ...
  const CreateBill = async (bill) => {
    let Items = cartItems.map((value) => value.id)
    ...
    var data = {
      ...
      shipName: '',
      urlPage: 'https://testseller.newee.asia',
    }
                ...
                <div className="left-header">
                  ...
                  {logged === true ? (
                    <FormShare
                      ...
                      totalPriceSeller={totalPaymentSeller}
                      listItems={cartItems}
                ...
                <div className="left-body">
                  <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="area-trans">
                      ...
                      <p>
                        Newee cung cấp phương thức vận chuyển nhanh Grab/Nowship tới các địa chỉ
                        trong khu vực thành phố Hồ Chí Minh. Quý đối tác muốn chọn vận chuyển nhanh,
                        xin vui lòng liên hệ hotline <span>0337.456.729</span> để được hỗ trợ.
                      </p>
                    </div>
                    ...
                    <div className="area-payment">
                      ...
                      <div className="d-flex-column active">
                        <span>
                          Trong thời gian nâng cấp hệ thống, Newee khuyến khích thanh toán bằng hình
                          thức này.
                        </span>
                      </div>
                      ...
                      <div className="d-flex-column active img">
                        ...
                        <span>Vui lòng liên hệ Hotline: 0337.456.729 để được hỗ trợ.</span>
                      </div>
                    </div>
                    ...
                    <div className="btns-group d-flex-space-between">
                      ...
                      <button type="submit" className="btn btn-primary" id="submitCheckout">
                        TIẾP TỤC
                      </button>
                    </div>
                  </form>
                          ...
                          <div className="carts-product-left d-flex-center">
                            ...
                            <div className="item-info">
                              ...
                              <div className="item-desc">
                                <span className="variant-title">{value.variantName}</span>
                              </div>
                            </div>
                          </div>
                    ...
                    <li className="d-flex-space-between">
                      ...
                      <div className="carts-product-right">
                        <span className="total">
                          {FormatVND(parseFloat(totalPayment) + parseFloat(priceShipping))} ₫
                        </span>
                      </div>
                    </li>
                  </ul>
