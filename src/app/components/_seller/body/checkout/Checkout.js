...
function Checkout2(props) {
  ...
  const {
    user,
    cart: { cartItems, totalPayment, totalPaymentSeller },
                ...
                <div className="left-body">
                  <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="btns-group d-flex-space-between">
                      <button type="button" className="btn-newee">
                        <Link to="/cart">QUAY LẠI GIỎ HÀNG</Link>
                      </button>
                      <button
                        type="submit"
                        className="btn-newee btn-newee-primary"
                        id="submitCheckout"
                      >
                        <span>TIẾP TỤC</span>
                      </button>
                    ...
                    <li className="d-flex-space-between">
                      ...
                      <div className="carts-product-right">
                        <span className="total">
                          {FormatVND(
                            parseFloat(totalPayment) + parseFloat(priceShipping)
                          )}{" "}
                          ₫
                        </span>
                      </div>
